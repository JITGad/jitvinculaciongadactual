...
public class MyCorsFilter {
				...
				if ((method != null) && (HTTP_METHODS.contains(method))) {
					if ("OPTIONS".equals(method)) {
						...
						if (contentType != null) {
						 ...
						 // Si el campo contentType es anulable, el valor predeterminado es dominio cruzado simple, evitando que la falta de este campo no pueda exportar dominio cruzado hqj 2018.10.19
						else {
							requestType = CORSRequestType.SIMPLE;
						}
	...
	protected static boolean isValidOrigin(String origin) {
		 // Eliminar la verificación del nombre del protocolo para evitar que "192.168.2.225:8080" pase hqj 2018-10-19
		return true;
		/*
